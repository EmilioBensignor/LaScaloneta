...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-12-2024 a las 03:14:53
...
CREATE TABLE `jugadores` (
  `jugador_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `usuario_fk` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `jugadores` (`usuario_fk`, `estado_publicacion_fk`, `numero_camiseta`, `nombre`, `apellido`, `club`, `descripcion`, `imagen_jugador`, `alt_imagen_jugador`, `imagen_camiseta`, `alt_imagen_camiseta`, `precio`) VALUES
(3, 1, 16, 'Alejandro', 'Garnacho', 'Manchester United', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', '20241218230456_garnacho.jpeg', 'Ale Garna', '20241218230456_garnacho.jpeg', 'aaaaaaaaaaaaaaaaaaaaaaaa', 0.00),
...
CREATE TABLE `jugadores_tienen_posiciones` (
  ...
  PRIMARY KEY (`jugador_fk`,`posicion_fk`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
(1, 4),  -- Changed from (0, 4) to reference first valid ID
(2, 1),  -- Changed from (1, 1) to match new IDs
(3, 2),  -- And so on...
(4, 2),
(5, 2),
(6, 3),
...
--
ALTER TABLE `detalle_compras`
  MODIFY `detalle_compra_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
