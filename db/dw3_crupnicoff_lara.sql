...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-12-2024 a las 23:41:18
...
--
-- Base de datos: `dw3_crupnicoff_lara`
--
...
INSERT INTO `compras` (`compra_id`, `usuario_fk`, `fecha_compra`, `total`) VALUES
(1, 6, '2024-12-16 11:16:47', 235000.00),
(2, 6, '2024-12-19 01:26:25', 805000.00),
(3, 6, '2024-12-19 20:16:27', 730000.00),
(4, 6, '2024-12-19 20:53:14', 510000.00),
(5, 8, '2024-12-20 18:52:03', 290000.00);
...
INSERT INTO `detalle_compras` (`detalle_compra_id`, `compra_fk`, `jugador_fk`, `cantidad`, `precio`) VALUES
(1, 1, 2, 2, 80000.00),
(3, 2, 3, 3, 80000.00),
(4, 2, 7, 5, 75000.00),
(5, 2, 12, 2, 95000.00),
...
CREATE TABLE `jugadores` (
  ...
  `numero_camiseta` tinyint(2) UNSIGNED NOT NULL CHECK (`numero_camiseta` between 1 and 99),
...
(4, 'juanperez@gmail.com', '$2y$10$t4oT8la81CCannVazBpykeiNaGEq0CfPtYlayGdo95W0pfmujHuMW', 'Juan', 'Perez', 2),
(6, 'laracrup@gmail.com', '$2y$10$D2nFzYYnfbXf7gyS8R1EJ.xuHPTNhCwh2zrb0Niw5Po5dr7cHU8xe', 'lara', 'crup', 2),
(7, 'mariagomez@gmail.com', '$2y$10$./pn6OgA71JCz7tK6jsbMupAuMIwj2uppbcrIXh4wqZLBIvmKL9yK', 'Maria', 'Gomez', 2),
(8, 'markm@gmail.com', '$2y$10$.B1AclKURuCphFSLrm2q/eLkV2jIUkBiaWUSEJH2W3ZLYnbp/W/Ma', 'Mark', 'My', 2);
...
ALTER TABLE `estados_publicacion`
  ...
  ADD KEY `estado_publicacion_id` (`estado_publicacion_id`);
...
--
ALTER TABLE `compras`
  MODIFY `compra_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `detalle_compras`
--
ALTER TABLE `detalle_compras`
  MODIFY `detalle_compra_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `jugadores`
  MODIFY `jugador_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
