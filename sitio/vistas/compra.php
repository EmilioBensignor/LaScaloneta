...
<main class="main-compra">
    ...
    <section class="compra">
        ...
        <form action="acciones/compra/procesar.php" method="post">
            <div class="formContainer">
                ...
                <div class="formFila">
                    ...
                    <input type="text" id="numero" name="numero" required pattern="[0-9]{16}"
                        title="Ingrese los 16 dígitos de la tarjeta">
                </div>
            </div>
            <div class="formContainer">
                <div class="formFila">
                    ...
                    <input type="text" id="vencimiento" name="vencimiento" required
                        pattern="(0[1-9]|1[0-2])\/([0-9]{2})" title="Formato MM/YY">
                </div>
                <div class="formFila">
            ...
            <button type="submit" class="botonPrimario">Confirmar Compra</button>
        </form>
    </section>
</main>
